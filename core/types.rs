    ...
    fn add(self, rhs: Self) -> Self::Output {
        match (self, rhs) {
            ...
            (Self::Text(string_left), Self::Text(string_right)) => Self::build_text(Rc::new(
                string_left.as_str().to_string() + &string_right.as_str().to_string(),
            )),
            ...
            (Self::Integer(int_left), Self::Text(string_right)) => Self::build_text(Rc::new(
                int_left.to_string() + &string_right.as_str().to_string(),
            )),
            ...
            (Self::Float(float_left), Self::Text(string_right)) => {
                ...
                Self::build_text(Rc::new(string_left + &string_right.as_str().to_string()))
            }
            (lhs, Self::Null) => lhs,
            (Self::Null, rhs) => rhs,
            _ => Self::Float(0.0),
